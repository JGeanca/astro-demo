...
<div
  class="bg-gray-800 border-2 border-orange-500 rounded-lg p-6 shadow-lg hover:shadow-orange-500/20 transition-all"
>
  ...
  <h2 class="text-xl font-bold text-orange-400 text-center mb-2">
    Componente Svelte
  </h2>
  <p class="text-gray-300 mb-4 text-center">
    Esta es una isla construida con Svelte
  </p>
